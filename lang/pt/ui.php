...
return [
    ...
    'document_language' => 'Idioma deste texto: :language',
    ...
    'review_state_draft_description' => 'Escrito, mas ainda ninguém responde por ele. Um documento que as pessoas aceitam não é publicado enquanto algum dos seus idiomas ainda for um rascunho.',
    'review_state_draft_short' => 'Rascunho',
    'review_state_reviewed' => 'Revisto',
    'review_state_reviewed_description' => 'Uma pessoa leu este idioma e responde por ele. Só fica online quando o documento for publicado.',
    ...
    'admin_translate_running' => 'Tradução em curso…',
    ...
    'admin_status_translation_running' => 'Já está em curso uma tradução deste rascunho. O resultado aparecerá aqui assim que terminar.',
    ...
    'admin_status_deemed_window_incomplete' => 'Não publicado — uma publicação com prazo de oposição precisa destes campos: :fields',
    'admin_status_deemed_dates_unreadable' => 'Não publicado — estas datas não podem ser lidas: :fields. Formato esperado: AAAA-MM-DD.',
