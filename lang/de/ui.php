...
// UI-Strings der publizierbaren Stubs (Einstellungsseite + Grace-Period-Banner). Die drei
// Rechtstypen bleiben getrennt benannt (Verträge / Kenntnisnahme / Einwilligungen). Per Du.
return [
