...
return [
    ...
    'common' => [
        ...
        'why' => 'Recibes este mensaje porque tienes una cuenta con nosotros y estamos obligados a informarte de este cambio. No es publicidad y no hay nada de lo que darse de baja.',
        'no_reply' => 'Esta dirección no admite respuestas. Usa el enlace de arriba si quieres actuar.',
        'more' => 'Aviso legal',
        'privacy' => 'Política de privacidad',
        'subject_effective' => ':subject (en vigor el :date)',
    ],
    'contract' => [
