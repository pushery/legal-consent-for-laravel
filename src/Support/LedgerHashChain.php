 ...
 * both its immutable content AND its own `prev_record_hash`, so any later edit, deletion,
 * insertion, or reorder within a subject's history breaks the chain and is surfaced by
 * `legal-consent:verify-ledger`.
 *
